		...
		try
		{
			...
			do {
				...
				{	
					...
					System.out.print("EmailId : " + user_EmailId );
			...
			{						
				...
				System.out.println("Enter 6 for no of following of login id: ");
				System.out.println("Enter 7 for no of followers of a certain person : ");
				System.out.println("Enter 8 to count number of questions asked: ");
				...
				System.out.println("Enter 12 to comment on answer: ");
				...
				case 0:
					...
					System.out.print("Add Interests :- ");
				...
				case 4:
					...
					System.out.println("Enter UserId of Person you want to follow : ");
					int UId = sc.nextInt();
				...
				case 9:
					...
					if(m==1)
					{
						...
						System.out.println("Enter QId of Question you want to Answer : ");
						QID = sc.nextInt();
				...
				case 11:
					...
					System.out.print("AnsId\t\tAnswers");
				...
				case 12:
...

					{
						...
						QID11C =rsQ111C.getInt("AnsId");
						Answer1C =rsQ111C.getString("Answer");
						System.out.println(Question1C + "\t\t\t" + QID11C + "\t\t" + Answer1C);
					...
					System.out.println("Enter AnsId of the Answer on which you want to comment : ");
					QID11C = sc.nextInt();
				...
				case 15:
					...
					ResultSet rs141 = pstmt.executeQuery();
					...
					Count2 =rs141.getInt("count(Answer)");
